...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/') }}{{ !empty($settings->favicon) ? $settings->favicon : '' }}" type="image/x-icon" />

    <!-- Fonts and icons -->
    <script src="{{ asset('build/backend') }}/js/plugin/webfont/webfont.min.js"></script>
    <script>
        WebFont.load({
            google: {
            ...
            custom: {
                ...
                urls: ["{{ asset('build/backend') }}/css/fonts.min.css"],
            },
            active: function() {
...
<body>
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('build/backend') }}/img/jm_denis.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('build/backend') }}/img/chadengle.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('build/backend') }}/img/mlane.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('build/backend') }}/img/talha.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('build/backend') }}/img/profile2.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
                                        ...
                                        <li>
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    ...
                                                    <p class="text-muted">
                                                        {{ auth()->user()->roles()->pluck('name')->first() }}</p>
                                                    <a href="profile.html"
    ...
    <!-- Chart JS -->
    <script src="{{ asset('build/backend') }}/js/plugin/chart.js/chart.min.js"></script>

    <!-- jQuery Sparkline -->
    <script src="{{ asset('build/backend') }}/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Circle -->
    <script src="{{ asset('build/backend') }}/js/plugin/chart-circle/circles.min.js"></script>

    <!-- Datatables -->
    <script src="{{ asset('build/backend') }}/js/plugin/datatables/datatables.min.js"></script>

    <!-- Bootstrap Notify -->
    <script src="{{ asset('build/backend') }}/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

    <!-- jQuery Vector Maps -->
    <script src="{{ asset('build/backend') }}/js/plugin/jsvectormap/jsvectormap.min.js"></script>
    <script src="{{ asset('build/backend') }}/js/plugin/jsvectormap/world.js"></script>

    <!-- Sweet Alert -->
    <script src="{{ asset('build/backend') }}/js/plugin/sweetalert/sweetalert.min.js"></script>

    <!-- Kaiadmin JS -->
    <script src="{{ asset('build/backend') }}/js/kaiadmin.min.js"></script>
