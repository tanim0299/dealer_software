        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-round">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2"><span>Sales Amount</span><strong>Tk {{ number_format($todaySalesAmount,2) }}</strong></div>
                        <div class="d-flex justify-content-between mb-2"><span>Sales Paid</span><strong>Tk {{ number_format($todaySalesPaid,2) }}</strong></div>
                        <div class="d-flex justify-content-between mb-2"><span>Due Collection</span><strong>Tk {{ number_format($todayCollectionAmount,2) }}</strong></div>
                        <div class="d-flex justify-content-between mb-2"><span>Purchase Amount</span><strong>Tk {{ number_format($todayPurchaseAmount,2) }}</strong></div>
                        <div class="d-flex justify-content-between mb-2"><span>Expense</span><strong class="text-danger">Tk {{ number_format($todayExpenseAmount,2) }}</strong></div>
                        <div class="d-flex justify-content-between"><span>Return Paid</span><strong class="text-danger">Tk {{ number_format($todayReturnPaid,2) }}</strong></div>
                    </div>
                </div>
            </div>
