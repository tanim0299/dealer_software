...
<div class="container">
    ...
    <div class="summary-box">
        ...
        <div class="summary-item">Return total (grand)<strong>{{ number_format($summary['subtotal'], 2) }}</strong></div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-end">{{ number_format((float) (($row->grand_total ?? 0) > 0 ? $row->grand_total : $row->subtotal), 2) }}</td>
            </tr>
            @empty
