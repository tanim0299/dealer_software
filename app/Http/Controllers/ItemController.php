...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        [$status_code, $status_message, $response] = (new ItemService())->ItemList($data['search'], true);
        $data['data'] = $response;
    ...
    {
        [$status_code, $status_message , $error_message] = (new ItemService())->storeItem($request);
    ...
    {
        [$status_code, $status_message, $data] = (new ItemService())->getItemById($id);
        $data['data'] = $data;
    ...
    public function update(Request $request, string $id)
    {
        [$status_code, $status_message, $error_message] =
            (new ItemService())->updateItem($request, $id);
    ...
    {
        [$status_code, $status_message] = (new ItemService())->deleteItem($id);
    ...
    {
        [$status_code, $status_message] = (new ItemService())->updateItemStatus($request->id);
